...
namespace OperationPlanner
{
    public partial class FormAddPatient : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Patient pat = new Patient(txtName.Text.Trim(), age, bmi, cancer, cvd, dementia, diabetes, digestive, osteoart, psych, pulmonary, charlson, mortality_rsi, complication_rsi, txtSurgery_type.Text.Trim());
