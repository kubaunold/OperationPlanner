...
namespace OperationPlanner
{
    class DbPatient
    {
        ...
        public static void AddPatient(Patient pat)
        {
            ...
            cmd.Parameters.Add("@PatientJUP_priority", MySqlDbType.Int32).Value = pat.JUP_priority;
